...
public static class CopyPasteTransformComponent {
    struct TransformData {
        ...
        public TransformData(Vector3 position, Quaternion localRotation, Vector3 localScale) {
    ...
    public static void CopyTransformValues() {
        ...
        _data = new TransformData(selectionTr.position, selectionTr.localRotation, selectionTr.localScale);
    }
